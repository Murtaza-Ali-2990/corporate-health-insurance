...
class _RegisterState extends State<RegisterHospital> {
                ...
                child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8.0),
                        TextFormField(
                          initialValue: model.capacity,
                          decoration:
                              textInputDecor.copyWith(hintText: 'Capacity'),
                          validator: (value) {
  ...
  Future _verifyRegister() async {
    if (_key.currentState.validate()) {
      ...
      dynamic user = await AuthService().registerHospital(model);
